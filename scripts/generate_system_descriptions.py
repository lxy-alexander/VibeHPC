...
trt_version = "TensorRT 10.14"
cuda_version = "CUDA 13.1"
cudnn_version = "cuDNN 9.17"
trtllm_version = "TensorRT-LLM feat/1.2-mlpinf"
nvidia_dynamo_version = "NVIDIA Dynamo mlperf-v6.0-dynamo-v0.8.0"
vllm_version = "vLLM CentML:mlperf-inf-mm-q3vl-v6.0"
os_version = "Ubuntu 24.04"
hopper_driver_version = "Driver 550.90"
submitter = "NVIDIA"

blackwell_driver_version = "Driver 580.67"
graceblackwell_driver_version = "Driver 580.67"
...
DGX_B300 = Machine(
    ...
    disk_controllers="NVMe",
    disk_drives="SSD",
    accelerator_model_name="NVIDIA B300-SXM-270GB",
    accelerator_short_name="B300-SXM-270GB",
    mig_short_name="",
    number_of_nodes=1,
    accelerator_memory_capacity="270 GB",
    accelerator_memory_configuration="HBM3e",
    hw_notes="B300 TGP 1100W",
    sw_notes="",
    system_id_prefix="",
    system_name_prefix="NVIDIA DGX B300",
    host_memory_configuration="32x 64GB HMCG94AGBRA179N",
    host_networking="Infiniband; Data bandwidth for GPU-PCIe: 504GB/s; PCIe-NIC: 500GB/s",
    host_network_card_count="10x 400Gbe Infiniband",
    host_networking_topology="Ethernet/Infiniband on switching network",
...
GB200_NVL4 = Machine(
    ...
    accelerator_memory_configuration="HBM3e",
    hw_notes="NVIDIA GB200 NVL72, 1200W TGP Per GPU",
    sw_notes="",
    system_id_prefix="GB200-NVL72",
    system_name_prefix="NVIDIA GB200 NVL72",
...
GB300_NVL4 = Machine(
    ...
    disk_drives="SSD",
    number_of_nodes=1,
    accelerator_model_name="NVIDIA GB300",
    accelerator_short_name="GB300-288GB_aarch64",
    mig_short_name="",
    accelerator_memory_capacity="288 GB",
    accelerator_memory_configuration="HBM3e",
    hw_notes="NVIDIA GB300 NVL72, 1400W TGP Per GPU",
    sw_notes="",
    system_id_prefix="GB300-NVL72",
    system_name_prefix="NVIDIA GB300 NVL72",
    host_memory_configuration="for each 4-GPU node: 1.3TB LPDDR5x",
    host_networking="Ethernet(IPoIB)",
    host_network_card_count="for each 4-GPU node: 4x Mellanox MT43244 BlueField-3 [ConnectX-7 Lx], 1x Intel I210 Gigabit Ethernet",
    host_networking_topology="Ethernet(IPoIB)/Infiniband on switching network",
...
class System():
    def __init__(self, machine, division, system_type, gpu_count=1, mig_count=0, is_soc=False, is_maxq=False, additional_config=""):
    ...
    def _get_framework(self, machine, division, gpu_count, mig_count, is_soc, is_maxq, additional_config):
        ...
        # Add TRTLLM, NVIDIA Dynamo, and vLLM for datacenter systems
        if not is_soc:
            frameworks.append(trtllm_version)
            frameworks.append(nvidia_dynamo_version)
            frameworks.append(vllm_version)
...
submission_systems = [
    ...
    #                                                        #gpu  mig  SOC   MaxQ
    System(GB200_NVL72, Division.CLOSED, SystemType.DATACENTER, 72, 0, False, False),  # GB200-NVL72
    System(GB200_NVL4, Division.CLOSED, SystemType.DATACENTER, 4, 0, False, False),  # GB200-NVL4
    System(GB300_NVL72, Division.CLOSED, SystemType.DATACENTER, 72, 0, False, False),  # GB300-NVL72
    System(GB300_NVL4, Division.CLOSED, SystemType.DATACENTER, 4, 0, False, False),  # GB300-NVL4
    System(DGX_B200, Division.CLOSED, SystemType.DATACENTER, 8, 0, False, False),  # B200x8
    System(DGX_B300, Division.CLOSED, SystemType.DATACENTER, 8, 0, False, False),  # B300x8

    # Edge submissions
    # System(ORIN_AGX_MAXP, Division.CLOSED, SystemType.EDGE, 1, 0, True, False),  # Jetson AGX Orin MaxP
]

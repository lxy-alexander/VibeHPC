See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v6.0/blob/refs/heads/main/closed/NVIDIA/results/GB200-NVL72_GB200-186GB_aarch64x72_TRT/summary.html)
<header class="topbar">
...
<div class="titlebar">
<h1 class="main-title">MLPerf Inference v6.0</h1>
<p class="main-title-description">Copyright 2019 - 2025 MLCommons</p>
<span class="date-right">February 2026</span>
</div>
</div>
<div class="table table-full submittertitle">
<h2>NVIDIA - NVIDIA GB200 NVL72 (72x GB200-186GB_aarch64, TensorRT)</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v6.0/tree/main/closed/NVIDIA/src" class="button">Src</a>
<a href="https://github.com/mlcommons/submissions_inference_v6.0/tree/main/closed/NVIDIA/results/GB200-NVL72_GB200-186GB_aarch64x72_TRT" class="button">Result Logs</a>
</div>
</div>
</div>
...
<table class="table">
<tr><td>accelerator_model_name</td><td>NVIDIA GB200</td></tr><tr><td>accelerators_per_node</td><td>4</td></tr><tr><td>accelerator_memory_capacity</td><td>186 GB</td></tr><tr><td>accelerator_host_interconnect</td><td>NVLink-C2C</td></tr><tr><td>accelerator_frequency</td><td></td></tr><tr><td>accelerator_interconnect</td><td>5th-gen NVLink andNVLink Switches</td></tr><tr><td>accelerator_interconnect_topology</td><td></td></tr><tr><td>accelerator_memory_configuration</td><td>HBM3e</td></tr><tr><td>accelerator_on-chip_memories</td><td></td></tr></table></div></div>
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 0L0 3.42863L3.24487 0L0 0Z" fill="#FBBC04"></path>
<path d="M8.29399 0L0 8.76368L0 12.202L11.5481 0L8.29399 0Z" fill="#FBBC04"></path>
...
<div class="table-container">
<table class="table">
<tr><td>host_processor_model_name</td><td>NVIDIA Grace CPU</td></tr><tr><td>host_processors_per_node</td><td>2</td></tr><tr><td>host_processor_core_count</td><td>144</td></tr><tr><td>host_processor_frequency</td><td></td></tr><tr><td>host_memory_capacity</td><td>1.87 TB</td></tr><tr><td>host_memory_configuration</td><td>for each 4-GPU node: 1.87TB LPDDR5x</td></tr><tr><td>host_processor_caches</td><td></td></tr><tr><td>host_processor_interconnect</td><td></td></tr></table></div></div>
</div>
<div class="table-half table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="table-container">
<table class="table">
<tr><td>cooling</td><td>Mix of Liquid-cooled (for CPU, GPU, CX7, NVLink Switches) and Air-cooled (for the rest of the components)</td></tr><tr><td>disk_controllers</td><td>NVMe</td></tr><tr><td>disk_drives</td><td>SSD</td></tr><tr><td>hw_notes</td><td>NVIDIA GB200 NVL72, 1200W TGP Per GPU</td></tr><tr><td>other_hardware</td><td></td></tr><tr><td>power_management</td><td></td></tr><tr><td>power_supply_details</td><td></td></tr><tr><td>power_supply_quantity_and_rating_watts</td><td></td></tr></table></div></div>
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 0L0 3.42863L3.24487 0L0 0Z" fill="#FBBC04"></path>
<path d="M8.29399 0L0 8.76368L0 12.202L11.5481 0L8.29399 0Z" fill="#FBBC04"></path>
...
<div class="table-container">
<table class="table">
<tr><td>boot_firmware_version</td><td></td></tr><tr><td>framework</td><td>TensorRT 10.14, CUDA 13.1, cuDNN 9.17, TensorRT-LLM feat/1.2-mlpinf, NVIDIA Dynamo mlperf-v6.0-dynamo-v0.8.0, vLLM CentML:mlperf-inf-mm-q3vl-v6.0</td></tr><tr><td>management_firmware_version</td><td></td></tr><tr><td>nics_enabled_firmware</td><td></td></tr><tr><td>operating_system</td><td>Ubuntu 24.04</td></tr><tr><td>other_software_stack</td><td>TensorRT 10.14, CUDA 13.1, cuDNN 9.17, Driver 580.126, TensorRT-LLM feat/1.2-mlpinf, NVIDIA Dynamo mlperf-v6.0-dynamo-v0.8.0, vLLM CentML:mlperf-inf-mm-q3vl-v6.0</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
</div>
<div class="table-full table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">deepseek-r1</td><td class="acc-target">exact_match: 80.5446, TOKENS_PER_SAMPLE: 3497.6047</td><td class="units">Tokens/s</td> <td class="perf">336106.000</td><td class="units">Tokens/s</td> <td class="perf">240318.000</td><td class="units">Tokens/s</td> <td class="perf">486141.000</td><tr><td class="model">dlrm-v3</td><td class="acc-target">DLRM_NE: 0.866, DLRM_ACC: 0.6958, DLRM_AUC: 0.7858</td><td class="units">Queries/s</td> <td class="perf">99996.800</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">104637.000</td><tr><td class="model">gpt-oss-120b</td><td class="acc-target">exact_match: 82.2987</td><td class="units">Tokens/s</td> <td class="perf">899218.000</td><td class="units">Tokens/s</td> <td class="perf">624929.000</td><td class="units">Tokens/s</td> <td class="perf">879542.000</td><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">810104.000</td><td class="units">Tokens/s</td> <td class="perf">754855.000</td><td class="units">Tokens/s</td> <td class="perf">888054.000</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">810104.000</td><td class="units">Tokens/s</td> <td class="perf">754855.000</td><td class="units">Tokens/s</td> <td class="perf">888054.000</td><tr><td class="model">llama3.1-405b</td><td class="acc-target">ROUGEL: 21.4499, exact_match: 89.2322, TOKENS_PER_SAMPLE: 616.212</td><td class="units">Tokens/s</td> <td class="perf">14133.900</td><td class="units">Tokens/s</td> <td class="perf">14010.100</td><td class="units">Tokens/s</td> <td class="perf">15461.500</td></table></div></div>
</div>
</div>
</main>

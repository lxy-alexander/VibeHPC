See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v6.0/blob/refs/heads/main/closed/NVIDIA/results/B200-SXM-180GBx8_TRT/summary.html)
<header class="topbar">
...
<a href="https://github.com/mlcommons/submissions_inference_v6.0/tree/main/closed/NVIDIA/results/B200-SXM-180GBx8_TRT" class="button">Result Logs</a>
</div>
</div>
</div>
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">dlrm-v3</td><td class="acc-target">DLRM_NE: 0.866, DLRM_ACC: 0.6958, DLRM_AUC: 0.7858</td><td class="units">Queries/s</td> <td class="perf">10007.000</td><td class="units">Samples/s</td> <td class="perf">10547.400</td><td class="na" colspan="2"> N/A </td><tr><td class="model">wan-2.2-t2v-a14b</td><td class="acc-target">vbench_score: 69.7752</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">0.046</td><td class="units">Latency (s)</td> <td class="perf">25.458</td><tr><td class="model">whisper</td><td class="acc-target">ACCURACY: 96.9536</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">47433.900</td><td class="na" colspan="2"> N/A </td></table></div></div>
</div>
</div>
</main>

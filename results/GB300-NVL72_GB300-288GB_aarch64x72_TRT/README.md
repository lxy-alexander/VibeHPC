See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v6.0/blob/refs/heads/main/closed/NVIDIA/results/GB300-NVL72_GB300-288GB_aarch64x72_TRT/summary.html)
<header class="topbar">
...
<h2>NVIDIA - NVIDIA GB300 NVL72 (72x GB300-288GB_aarch64, TensorRT)</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v6.0/tree/main/closed/NVIDIA/results/GB300-NVL72_GB300-288GB_aarch64x72_TRT" class="button">Result Logs</a>
</div>
</div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>host_processor_model_name</td><td>NVIDIA Grace CPU</td></tr><tr><td>host_processors_per_node</td><td>2</td></tr><tr><td>host_processor_core_count</td><td>144</td></tr><tr><td>host_processor_frequency</td><td></td></tr><tr><td>host_memory_capacity</td><td>2.2 TB</td></tr><tr><td>host_memory_configuration</td><td>for each 4-GPU node: 2.2TB LPDDR5x</td></tr><tr><td>host_processor_caches</td><td></td></tr><tr><td>host_processor_interconnect</td><td></td></tr></table></div></div>
</div>
<div class="table-half table-striped">
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">deepseek-r1</td><td class="acc-target">exact_match: 80.5446, TOKENS_PER_SAMPLE: 3497.6047</td><td class="units">Tokens/s</td> <td class="perf">400437.000</td><td class="units">Tokens/s</td> <td class="perf">250634.000</td><td class="units">Tokens/s</td> <td class="perf">647076.000</td><tr><td class="model">gpt-oss-120b</td><td class="acc-target">exact_match: 82.2987</td><td class="units">Tokens/s</td> <td class="perf">1072250.000</td><td class="units">Tokens/s</td> <td class="perf">677199.000</td><td class="units">Tokens/s</td> <td class="perf">1042980.000</td><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">868278.000</td><td class="units">Tokens/s</td> <td class="perf">814128.000</td><td class="units">Tokens/s</td> <td class="perf">1126850.000</td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">868278.000</td><td class="units">Tokens/s</td> <td class="perf">814128.000</td><td class="units">Tokens/s</td> <td class="perf">1126850.000</td><tr><td class="model">llama3.1-405b</td><td class="acc-target">ROUGEL: 21.4499, exact_match: 89.2322, TOKENS_PER_SAMPLE: 616.212</td><td class="units">Tokens/s</td> <td class="perf">18627.600</td><td class="units">Tokens/s</td> <td class="perf">18365.400</td><td class="units">Tokens/s</td> <td class="perf">19511.700</td></table></div></div>
</div>
</div>
</main>

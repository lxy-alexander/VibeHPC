See the HTML preview [here](https://htmlpreview.github.io/?https://github.com/mlcommons/submissions_inference_v6.0/blob/refs/heads/main/closed/NVIDIA/results/B300-SXM-270GBx8_TRT/summary.html)
<header class="topbar">
...
<h2>NVIDIA - NVIDIA DGX B300 (8x B300-SXM-270GB, TensorRT)</h2>
</div>
...
<a href="https://github.com/mlcommons/submissions_inference_v6.0/tree/main/closed/NVIDIA/results/B300-SXM-270GBx8_TRT" class="button">Result Logs</a>
</div>
</div>
</div>
...
<div class="table-container">
<table class="table">
<tr><td>cooling</td><td>Air-cooled</td></tr><tr><td>disk_controllers</td><td>NVMe</td></tr><tr><td>disk_drives</td><td>SSD</td></tr><tr><td>hw_notes</td><td>B300 TGP 1100W</td></tr><tr><td>other_hardware</td><td></td></tr><tr><td>power_management</td><td></td></tr><tr><td>power_supply_details</td><td></td></tr><tr><td>power_supply_quantity_and_rating_watts</td><td></td></tr></table></div></div>
<div class="table-wrapper"><div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
<svg role="presentation" aria-hidden="true" width="83" height="21" viewBox="0 0 83 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 0L0 3.42863L3.24487 0L0 0Z" fill="#FBBC04"></path>
<path d="M8.29399 0L0 8.76368L0 12.202L11.5481 0L8.29399 0Z" fill="#FBBC04"></path>
...
<th>Metric</th>
<th>Performance</th>
</tr><tr><td class="model">deepseek-r1</td><td class="acc-target">exact_match: 80.5446, TOKENS_PER_SAMPLE: 3497.6047</td><td class="units">Tokens/s</td> <td class="perf">42721.400</td><td class="units">Tokens/s</td> <td class="perf">70325.700</td><td class="na" colspan="2"> N/A </td><tr><td class="model">gpt-oss-120b</td><td class="acc-target">exact_match: 82.2987</td><td class="units">Tokens/s</td> <td class="perf">100328.000</td><td class="units">Tokens/s</td> <td class="perf">103961.000</td><td class="na" colspan="2"> N/A </td><tr><td class="model">llama2-70b-99</td><td class="acc-target">ROUGE1: 43.9869, ROUGE2: 21.8148, ROUGEL: 28.33, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">107318.000</td><td class="units">Tokens/s</td> <td class="perf">112954.000</td><td class="na" colspan="2"> N/A </td><tr><td class="model">llama2-70b-99.9</td><td class="acc-target">ROUGE1: 44.3868, ROUGE2: 22.0132, ROUGEL: 28.5876, TOKENS_PER_SAMPLE: 265.005</td><td class="units">Tokens/s</td> <td class="perf">107318.000</td><td class="units">Tokens/s</td> <td class="perf">112954.000</td><td class="na" colspan="2"> N/A </td><tr><td class="model">llama3.1-405b</td><td class="acc-target">ROUGEL: 21.4499, exact_match: 89.2322, TOKENS_PER_SAMPLE: 616.212</td><td class="units">Tokens/s</td> <td class="perf">1460.250</td><td class="units">Tokens/s</td> <td class="perf">1951.600</td><td class="na" colspan="2"> N/A </td><tr><td class="model">llama3.1-8b</td><td class="acc-target">ROUGE1: 38.3914, ROUGE2: 15.7484, ROUGEL: 24.2507, ROUGELSUM: 35.4351, GEN_LEN: 7350879.6</td><td class="units">Tokens/s</td> <td class="perf">141565.000</td><td class="units">Tokens/s</td> <td class="perf">165432.000</td><td class="na" colspan="2"> N/A </td><tr><td class="model">wan-2.2-t2v-a14b</td><td class="acc-target">vbench_score: 69.7752</td><td class="na" colspan="2"> N/A </td><td class="units">Samples/s</td> <td class="perf">0.059</td><td class="units">Latency (s)</td> <td class="perf">23.779</td></table></div></div>
</div>
</div>
</main>
